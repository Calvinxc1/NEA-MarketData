...
const BlueprintDetailsHeader = ({blueprint}) => <Row>
  <Col xs={3}>
    <Figure>
      <Figure.Image
        width={128}
        height={128}
        src={parseTypeImageUrl(blueprint.type, 128,
          blueprint.bp_type === 'copy' ? 'bpc'
          : blueprint.bp_type === 'relic' ? 'relic'
          : 'bp'
        )}
      />
  ...
  <Col>
    ...
    <Figure>
      <Figure.Image
        width={64}
        height={64}
        src={parseTypeImageUrl(blueprint.parent_station.type, 64)}
      />
...
export default BlueprintDetailsHeader;
