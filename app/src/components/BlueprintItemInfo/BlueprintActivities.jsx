...
const BlueprintActivities = ({activities, material_efficiency, time_efficiency, max_production_limit, runs, updateRuns}) => <Accordion className='shadow-sm'>
  <Card.Header><Row>
    <Col xs={2}>
      <InputGroup>
        <InputGroup.Prepend>
        ...
        <FormControl
          ...
          value={runs}
          onChange={(e) => updateRuns(Number(e.target.value))}
        />
      </InputGroup>
    </Col>
    <Col xs={10}>
...
export default BlueprintActivities;
